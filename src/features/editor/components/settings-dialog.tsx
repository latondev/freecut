...
export function SettingsDialog({ open, onOpenChange }: SettingsDialogProps) {
  ...
  const timelineSkimmingEnabled = useSettingsStore((s) => s.timelineSkimmingEnabled)
                    ...
                    {activeSection === 'timeline' && (
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <Label className="text-sm">
                              {t('settings.timeline.enableTimelineSkimming')}
                            </Label>
                            <p className="text-xs text-muted-foreground">
                              {t('settings.timeline.enableTimelineSkimmingDescription')}
                            </p>
                          </div>
                          <Switch
                            checked={timelineSkimmingEnabled}
                            onCheckedChange={(v) => setSetting('timelineSkimmingEnabled', v)}
                          />
                        </div>
                        <div className="flex items-center justify-between">
